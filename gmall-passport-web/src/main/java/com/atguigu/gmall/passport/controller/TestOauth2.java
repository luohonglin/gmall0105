...
public class TestOauth2 {
    ...
    public static String getCode(){
        ...
        String s1 = HttpclientUtil.doGet("https://api.weibo.com/oauth2/authorize?client_id=3426136135&response_type=code&redirect_uri=http://passport.gmall.com:8085/vlogin");
    ...
    public static String getAccess_token(){
        ...
        paramMap.put("client_id","3426136135");
        paramMap.put("client_secret","1c6669de1bd3778adcd942ced80e33cb");
        paramMap.put("grant_type","authorization_code");
        paramMap.put("redirect_uri","http://passport.gmall.com:8085/vlogin");
        paramMap.put("code","f23c1b9942ae021410503820864c0fc6");// 授权有效期内可以使用，没新生成一次授权码，说明用户对第三方数据进行重启授权，之前的access_token和授权码全部过期
